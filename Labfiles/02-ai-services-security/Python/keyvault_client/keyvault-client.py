'''
First, install the packages you will need to use for Azure Key Vault and the Text Analytics API in your Azure AI services resource:
...
# At the end, in the integrated terminal, enter the following command to run the program: [python keyvault-client.py]
